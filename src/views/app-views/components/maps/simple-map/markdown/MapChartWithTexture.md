...
## en-US
The above map shows how to use react-simple-maps to add textures on the map. This example uses PatternLines from [VX](https://vx-demo.now.sh/static/docs/vx-pattern.html) to create a line texture.
